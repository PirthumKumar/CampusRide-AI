    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('avatar_url', models.CharField(blank=True, default='/static/images/default-avatar.png', max_length=500, null=True)),
                ...
                ('verification_doc', models.TextField(blank=True, null=True)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('notification_type', models.CharField(choices=[('booking_request', 'Booking Request'), ('booking_status', 'Booking Status Update'), ('new_message', 'New Message'), ('ride_update', 'Ride Update'), ('system', 'System Alert')], max_length=50)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('recurring_days', models.CharField(blank=True, max_length=100, null=True)),
                ('created_at', models.DateTimeField(auto_now_add=True)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('ride', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='reviews', to='core.ride')),
            ],
        ),
        migrations.CreateModel(
            name='Report',
            fields=[
                ...
                ('ride', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.SET_NULL, related_name='reports', to='core.ride')),
            ],
        ),
        migrations.CreateModel(
            name='Message',
            fields=[
                ...
                ('ride', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, related_name='chat_messages', to='core.ride')),
            ],
        ),
        migrations.CreateModel(
            name='Booking',
